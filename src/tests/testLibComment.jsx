...
function doesCommentIdHavePropperStructure(id) {
    ...
    if (!isPrefixCorrect) {
        console.log(
            "Prefix is not correct. Expected: 'c/'. Result: ",
            commentIdPrefix
        )
    }
...
function isResponseStructureWrong(res) {
    ...
    for (let i = 0; i < res.length; i++) {
        ...
        if (typeof commentAccountId !== 'string') {
            console.log(
                `In the commentData of index ${i} the accountId is not a string`
            )
            ...
            console.log(
                `In the commentData of index ${i} the author property in the metadata is not a string`,
                commentData
            )
            errorInStructure = true
        } else if (
            ...
            !doesRootIdHaveAValidFormat(commentData.value.metadata.rootId)
        ) {
            console.log(
